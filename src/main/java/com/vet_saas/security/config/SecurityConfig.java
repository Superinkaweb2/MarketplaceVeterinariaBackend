...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(req -> req
                        ...
                        .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/v1/adoptions/**").permitAll()
                        .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/v1/subscriptions/plans")
                        .permitAll()
    ...
    public org.springframework.web.cors.CorsConfigurationSource corsConfigurationSource() {
        ...
        // Cargar orígenes permitidos desde application.yaml
